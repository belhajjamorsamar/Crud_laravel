! function(t, e) {
    ...
    return L.generate = function(t) {
        ...
        var i, n, a, o, s, c, d, l, u, h, g, f, p, _, x, m, y, S, v, b, T, A, P, C, L, V, G, E, O, I = this,
            R = I.main,
            k = I.d3,
            D = I.config,
        ...
        if (t.resizeFunction = t.generateResize(), t.resizeFunction.add(function() {
                ...
                e.onresized.call(t)
            }), window.attachEvent) window.attachEvent("onresize", t.resizeFunction);
        else if (window.addEventListener) window.addEventListener("resize", t.resizeFunction, !1);
        else {
        ...
        n.prototype._isCurrentSpace = function() {
            ...
            if (this._skipOptionalSpaces(), this._currentIndex < this._endIndex && "+" == this._string.charAt(this._currentIndex) ? this._currentIndex++ : this._currentIndex < this._endIndex && "-" == this._string.charAt(this._currentIndex) && (this._currentIndex++, a = -1), !(this._currentIndex == this._endIndex || (this._string.charAt(this._currentIndex) < "0" || this._string.charAt(this._currentIndex) > "9") && "." != this._string.charAt(this._currentIndex))) {
                ...
                if (this._currentIndex != s)
                    for (var c = this._currentIndex - 1, d = 1; c >= s;) e += d * (this._string.charAt(c--) - "0"), d *= 10;
        ...
        var t = this.internal;
        if (window.clearInterval(t.intervalForObserveInserted), void 0 !== t.resizeTimeout && window.clearTimeout(t.resizeTimeout), window.detachEvent) window.detachEvent("onresize", t.resizeFunction);
        else if (window.removeEventListener) window.removeEventListener("resize", t.resizeFunction);
        else {
        ...
        var e, i, n, a, r, o, s, c = this.internal,
            d = [],
            u = c.getMaxDataCount(),
            h = 0,
            g = 0;
        ...
        e = c.convertDataToTargets(i, !0), c.data.targets.forEach(function(t) {
            ...
            for (e = 0; e < d.length; e++)
                if (t.id === d[e])
                    for (g = t.values[t.values.length - 1].index + 1, i = 0; i < h; i++) t.values.push({
                        id: t.id,
                        index: g + i,
        ...
        if (c.data_groups.length > 0)
            for (o = s.hasNegativeValueInTargets(t), e = 0; e < c.data_groups.length; e++)
                if (0 !== (a = c.data_groups[e].filter(function(t) {
                    ...
                    for (n = a[0], o && l[n] && l[n].forEach(function(t, e) {
                            l[n][e] = t < 0 ? t : 0
        ...
        var n, a, r, o, s, c, d, u, h, g, f = this,
            p = f.config,
        ...
        l.hasArcType() || u.data_selection_enabled && (u.zoom_enabled && !l.zoom.altDomain || u.data_selection_multiple && (e = l.dragStart[0], i = l.dragStart[1], n = t[0], a = t[1], o = Math.min(e, n), s = Math.max(e, n), c = u.data_selection_grouped ? l.margin.top : Math.min(i, a), d = u.data_selection_grouped ? l.height : Math.max(i, a), h.select("." + r.dragarea).attr("x", o).attr("y", c).attr("width", s - o).attr("height", d - c), h.selectAll("." + r.shapes).selectAll("." + r.shape).filter(function(t) {
            ...
            var i, n, a, u, h, f, p = g.select(this),
                _ = p.classed(r.SELECTED),
                x = p.classed(r.INCLUDED),
                m = !1;
            if (p.classed(r.circle)) i = 1 * p.attr("cx"), n = 1 * p.attr("cy"), h = l.togglePoint, m = o < i && i < s && c < n && n < d;
            else {
        ...
        if ("year" === t)
            for (n = (i = s.getXDomain())[0].getFullYear(), a = i[1].getFullYear(), o = n; o <= a; o++) c.push(new Date(o + "-01-01 00:00:00"));
        ...
        var o, s, c, d, l, u, h, g, f, p, _, x, m, y, S, v, b = this,
            T = b.config,
            A = 4,
            P = 10,
            C = 0,
        ...
        return a = n.axis_rotated ? a.x(c).y(s) : a.x(s).y(c), n.line_connectNull || (a = a.defined(function(t) {
            ...
            function(t) {
                var r, s = n.line_connectNull ? i.filterRemoveNull(t.values) : t.values,
                    c = e ? i.x : i.subX,
                    d = o.call(i, t.id),
                    l = 0,
                    u = 0;
        ...
        var r, o, s, c, d, l, u, h, g, f, p, _ = this,
            x = _.config,
            m = "M",
            y = _.isCategorized() ? .5 : 0,
            S = [];
        if (void 0 !== n)
            for (r = 0; r < n.length; r++) S[r] = {}, void 0 === n[r].start ? S[r].start = t[0].x : S[r].start = _.isTimeSeries() ? _.parseDate(n[r].start) : n[r].start, void 0 === n[r].end ? S[r].end = t[t.length - 1].x : S[r].end = _.isTimeSeries() ? _.parseDate(n[r].end) : n[r].end;
        for (f = x.axis_rotated ? function(t) {
            ...
            if (void 0 !== S && function(t, e) {
                ...
                for (c = _.getScale(t[r - 1].x + y, t[r].x + y, _.isTimeSeries()), d = _.getScale(t[r - 1].value, t[r].value), l = e(t[r].x) - e(t[r - 1].x), u = i(t[r].value) - i(t[r - 1].value), g = 2 * (h = 2 / Math.sqrt(Math.pow(l, 2) + Math.pow(u, 2))), o = h; o <= 1; o += g) m += s(t[r - 1], t[r], o, h);
            else m += " " + f(t[r]) + " " + p(t[r]);
            t[r].x
        }
        return m
        ...
        return a = n.axis_rotated ? a.x0(c).x1(d).y(s) : a.x(s).y0(n.area_above ? 0 : c).y1(d), n.line_connectNull || (a = a.defined(function(t) {
            ...
            function(t) {
                var e, r = n.line_connectNull ? i.filterRemoveNull(t.values) : t.values,
                    o = 0,
                    s = 0;
